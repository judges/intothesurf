...
+(NSArray*)CreateRaceInfo
{
	...
	eventArray=[[[NSMutableArray alloc]init] autorelease];
	[eventArray addObject:[RaceEvent RaceEventWithTitle:@"LavaKids" Location:@"Anaehoomalu Bay"         TimeFrom:[dateFormatter dateFromString:@"2011-04-02 8:00:00"]  TimeTo:[dateFormatter dateFromString:@"2011-04-02 10:00:00"]]];	
	[eventArray addObject:[RaceEvent RaceEventWithTitle:@"Packet Pickup" Location:@"Hilton Waikoloa"    TimeFrom:[dateFormatter dateFromString:@"2011-04-02 13:00:00"] TimeTo:[dateFormatter dateFromString:@"2011-04-02 16:00:00"]]];	
	[eventArray addObject:[RaceEvent RaceEventWithTitle:@"Pre-Race Meeting" Location:@"Hilton Waikoloa" TimeFrom:[dateFormatter dateFromString:@"2011-04-02 16:30:00"] TimeTo:[dateFormatter dateFromString:@"2011-04-02 17:30:00"]]];		
