...
#define SHKMyAppName			@"Jiggle"
#define SHKMyAppURL				@"http://intothesurf.com"
...
#define SHKFacebookKey				@"117606784962271"
#define SHKFacebookSecret			@"25a81894b117de1284c23d405f56a66f"
 ...
 */
#define SHKTwitterConsumerKey		@"x9xD9AeLDuXBB49esxwAfQ"
#define SHKTwitterSecret			@"nnXh9ReuvLMRcKRKYmtFVMbniPe7ZYECG9cSg3DwrrQ"
#define SHKTwitterCallbackUrl		@"http://www.intothesurf.com" // You need to set this if using OAuth, see note above (xAuth users can skip it)
